...
### NOTE
* All configurations are customized for me and my use cases, so it can be useful for someone who needs a minimal setup based on [dwm](https://dwm.suckless.org/) & [sxhkd](https://github.com/baskerville/sxhkd). 
